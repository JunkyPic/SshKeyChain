...
public class MacCommand implements ICommand {
    ...
    public void exec(String command) {
        try{
            final File file = new File(System.getProperty("user.dir") + "/Scripts/Connect.sh");
            ...
            ProcessBuilder pb = new ProcessBuilder(System.getProperty("user.dir") + "/Scripts/Connect.sh");
